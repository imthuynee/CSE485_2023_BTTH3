...
class ArticleController
{
    ...
    public function add()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $target = 'C:/xampp/htdocs/CSE485_2023_BTTH03_B3/views/images/songs/' . basename($_FILES['hinhanh']['name']);
            move_uploaded_file($hinhanh_tmp, $target);
            if ($result) {
                header('location:/CSE485_2023_BTTH03_B3/index.php?controller=article&action=list');
            }
        }
