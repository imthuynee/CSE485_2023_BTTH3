...
class AuthorController
{
    ...
    public function edit()
    {
        ...
        if (isset($_POST['save'])) {
            ...
            $target = 'C:/xampp/htdocs/CSE485_2023_BTTH03_B3/views/images/authors/' . basename($_FILES['hinh_tgia']['name']);
            move_uploaded_file($hinhanh_tmp, $target);
            if ($result) {
                header('location:/CSE485_2023_BTTH03_B3/index.php?controller=author&action=list');
            }
        }
