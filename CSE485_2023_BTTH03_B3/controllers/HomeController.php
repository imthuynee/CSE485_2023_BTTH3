...
class HomeController
{
            ...
            if ($users > 0) {
                ...
                if ($pass_hash = $password) {
                    if ($role == 'admin') {
                        ...
                        header('location:/CSE485_2023_BTTH03_B3/index.php?controller=admin&action=list');
                    } else {
    ...
    public function logout()
    {
        ...
        session_destroy();
        header("Location:/CSE485_2023_BTTH03_B3/index.php?controller=home&action=login");
        exit;
    }
